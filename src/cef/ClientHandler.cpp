...
bool ClientHandler::keyPressed(const OIS::KeyEvent &arg) {
...
bool ClientHandler::keyReleased(const OIS::KeyEvent &arg) {
...
bool ClientHandler::mouseMoved(const OIS::MouseEvent &arg) {
...
bool ClientHandler::mousePressed(const OIS::MouseEvent &arg, OIS::MouseButtonID id) {
    CefMouseEvent mouseEvent;
    mouseEvent.x = arg.state.X.abs;
    mouseEvent.y = arg.state.Y.abs;
...
bool ClientHandler::mouseReleased(const OIS::MouseEvent &arg, OIS::MouseButtonID id) {
    CefMouseEvent mouseEvent;
    mouseEvent.x = arg.state.X.abs;
    mouseEvent.y = arg.state.Y.abs;
