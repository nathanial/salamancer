...
${OBJECTDIR}/framework/Camera.o: framework/Camera.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/Camera.o framework/Camera.cpp

${OBJECTDIR}/framework/Chunk.o: framework/Chunk.cpp 
	${MKDIR} -p ${OBJECTDIR}/framework
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/Chunk.o framework/Chunk.cpp

${OBJECTDIR}/framework/Mesher.o: framework/Mesher.cpp 
	${MKDIR} -p ${OBJECTDIR}/framework
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/Mesher.o framework/Mesher.cpp

${OBJECTDIR}/framework/Volume.o: framework/Volume.cpp 
	${MKDIR} -p ${OBJECTDIR}/framework
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/Volume.o framework/Volume.cpp

${OBJECTDIR}/framework/World.o: framework/World.cpp 
	${MKDIR} -p ${OBJECTDIR}/framework
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/World.o framework/World.cpp

${OBJECTDIR}/framework/opengl/GLProgram.o: framework/opengl/GLProgram.cpp 
	${MKDIR} -p ${OBJECTDIR}/framework/opengl
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/opengl/GLProgram.o framework/opengl/GLProgram.cpp

${OBJECTDIR}/framework/opengl/Shader.o: framework/opengl/Shader.cpp 
	${MKDIR} -p ${OBJECTDIR}/framework/opengl
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/opengl/Shader.o framework/opengl/Shader.cpp
...
${OBJECTDIR}/framework/terrain/PerlinTerrainGenerator.o: framework/terrain/PerlinTerrainGenerator.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/terrain/PerlinTerrainGenerator.o framework/terrain/PerlinTerrainGenerator.cpp
